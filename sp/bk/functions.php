...
function contact_bnr() {
	ob_start();?>
  <p class="common_contact_bnr"> <span class="tit"><img src="<?php echo get_template_directory_uri(); ?>/images/common/tel_tit.png" alt="お気軽にお電話下さい！" width="580" height="75"></span><a href="tel:<?php the_field('comtel',  'Options'); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/common/tel_bnr.png" alt="お気軽にお電話下さい！" width="578" height="89"></a></p>
<?	$output = ob_get_clean();
	return $output;
}
...
function kaiyu_bnr() {
	ob_start();?>
	<ul class="kaiyu_bnr">
		<li><a href="<?php bloginfo('url'); ?>/gaiheki"><img src="<?php echo get_template_directory_uri(); ?>/images/common/kaiyu/btn_gaiheki.png" width="280" height="96" alt="外壁塗装"></a></li>
		<li><a href="<?php bloginfo('url'); ?>/yane"><img src="<?php echo get_template_directory_uri(); ?>/images/common/kaiyu/btn_yane.png" width="280" height="96" alt="屋根リフォーム"></a></li>
		<li><a href="<?php bloginfo('url'); ?>/amamori"><img src="<?php echo get_template_directory_uri(); ?>/images/common/kaiyu/btn_amamori.png" width="280" height="96" alt="雨漏り診断"></a></li>
		<li><a href="<?php bloginfo('url'); ?>/siroari"><img src="<?php echo get_template_directory_uri(); ?>/images/common/kaiyu/btn_amamori.png" width="280" height="96" alt="シロアリ"></a></li>
	</ul>
...
<div class="seko_archive">
	<ul class="list">
		...
		$pic_src = wp_get_attachment_image_src($pic, 'w330'); //表示サイズ 
		...
		?>
          ...
          <li><a href="<?php the_permalink(); ?>"><?if ($pic||$img_csv_after){echo '<span class="pic">';
				...
				echo '<img src="'.$pic_src[0].'" width="'.$pic_src[1].'" height="'.$pic_src[2].'" alt="'.get_the_title().'" class="img_over">';
					...
					echo '<img src="/wp-content/themes/reform/'.$img_csv_after.'" alt="写真" width="330" height="" class="img_over">';
				}
...
function catch_that_image() {
    ...
    if(empty($first_img)){ //Defines a default image
        $first_img = "/wp-content/themes/sp/images/default.gif";
    }
return $first_img;
}
//------------------------------------------------------------------------
